...
def test_ex_iris_saveto_ncdata():
    from tests.integration.ex_iris_saveto_ncdata import example_ncdata_from_iris
...
def test_ex_ncio_saveload_unlimited_roundtrip():
    from tests.integration.ex_ncdata_netcdf_conversion \
        import example_nc4_save_reload_unlimited_roundtrip
