...
class TestAttributesFromItems:
    ...
    def test_attributes__map(self, target_itemtype):
        # Create from classic map {name: NcAttr(name, value)}
        arg = {"x": NcAttribute("x", 1), "y": NcAttribute("y", 2)}
    ...
    def test_attributes__list(self, target_itemtype):
    ...
    def test_attributes__namevaluemap(self, target_itemtype):
